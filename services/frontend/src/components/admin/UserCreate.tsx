    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-100">Create New User</h1>
            <p className="text-slate-400">Add a new user to the system with appropriate permissions</p>
          </div>
        </div>
        ...
        <TabsContent value="basic" className="space-y-4">
          <Card>
            <CardContent className="pt-6 space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="keycloak_id">Keycloak User ID (Optional)</Label>
                <Input
                  id="keycloak_id"
                  placeholder="If user already exists in Keycloak, enter their ID"
