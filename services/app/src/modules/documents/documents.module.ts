...
import { Document, DocumentMeta, Matter, Client, RetentionClass, AuditLog, SystemSettings } from '../../common/entities';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([Document, DocumentMeta, Matter, Client, RetentionClass, AuditLog, SystemSettings]),
    SearchModule,
    QueueModule,
  ],
